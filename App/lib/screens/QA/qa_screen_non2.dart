...
import 'qa_screen_non3.dart';

/// QA step 4: elder's birthday. Question uses QA2's saved elder relationship (e.g. "What is your Daddy's birthday?").
class QAScreenNon2 extends StatefulWidget {
  const QAScreenNon2({super.key, required this.userRoleIndex});
  ...
  @override
  State<QAScreenNon2> createState() => _QAScreenNon2State();
}

class _QAScreenNon2State extends State<QAScreenNon2> {
  static const _keyNonGuardianQA2 = 'NonGuardianQA2';
  ...
  Future<void> _onNextPressed() async {
    ...
    await prefs.setString(_keyNonGuardianQA2, _formatBirthday(_birthday!));
    
    if (!mounted) return;

    Navigator.of(context).push(
      MaterialPageRoute<void>(
        builder: (_) => QAScreenNon3(userRoleIndex: widget.userRoleIndex),
      ),
    );    
